...
public class Usuario implements Serializable{
	...
	public Usuario(Usuario usu) {
		...
		archivoPokedexUsuario = new File (usu.getRutaArchivoPokedex());
	...
	public String getRutaArchivoPokedex() {
		return "src\\Usuario"+this.Nombre+"Pokedex";
	}
	public String getRutaArchivoCapturados()
	{
		return "src\\Usuario"+this.Nombre +"Capturados";
	}
	...
	public boolean restaurarVidas(ArrayList<Pokemon> curados)  throws ExcepcionGenerica
	{
		...
		archivoCapturados = new File ("src\\Usuario",getNombre());
