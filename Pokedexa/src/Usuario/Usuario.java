...
public class Usuario implements Serializable {
	...
	public Usuario() {
		super();
		Nombre = "null";
		archivoPokedexUsuario= new File ("Pokedexa\\src\\Usuario\\Usuario.PokedexUsuarios", getNombre()+"Pokedex.dat");
		archivoCapturados=new File ("Pokedexa\\src\\Usuario\\Usuario.CapturadosUsuarios",getNombre()+"Capturados.dat");
		archivoCapturadosCopia=new File ("Pokedexa\\src\\Usuario\\Usuario.CapturadosCopiaUsuarios",getNombre()+"CapturadosCopia.dat");
