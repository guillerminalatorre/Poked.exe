...
public class Usuario implements Serializable {
	...
	public Usuario() {
		super();
		Nombre = "null";
		archivoPokedexUsuario= new File ("src\\Usuario\\PokedexUsuarios", getNombre()+"Pokedex.dat");
		archivoCapturados=new File ("src\\Usuario\\CapturadosUsuarios",getNombre()+"Capturados.dat");
		archivoCapturadosCopia=new File ("src\\Usuario\\CapturadosCopiaUsuarios",getNombre()+"CapturadosCopia.dat");
